...
# Created by: Euel Yirga and Austin Harrty
# Created on: November 2019
# This programs is the breakout game
            ...
            if lasers[lasers_number].x > 0:
                for alien_number in range(len(aliens)):
                    if aliens[alien_number].x > 0:
                        ...
                        #
                        if stage.collide(lasers[lasers_number].x + 6, lasers[lasers_number].y + 2,
                                         lasers[lasers_number].x + 11, lasers[lasers_number].y + 12,
